...
include ("header.php");
include("data/calcularPatrimonio.php");
...
if(isset($_GET['year'])){
	...
	$patrimonio = $comp->getPatrimonio($idlibro1,$idlibro2);
...
<div class="container">
  ...
  <li class="btn btn-primary nav-item ">
    <?php echo ('<a class="nav-link text-white" href="pneto.php?year='.$year.'&elegir='.$idempresa.'&edit=true">Editar año actual</a>'); ?>
        
    

  </li>
  <li class="btn btn-primary nav-item ">
    <?php echo ('<a class="nav-link text-white" href="pneto.php?year='.$yearmenor.'&elegir='.$idempresa.'&edit=true-1">Editar año anterior</a>'); ?>
...
<div class="container">
    <div class="row justify-content-md-center">
        <?php echo($comp->generarTablaPatrimonio($patrimonio));?>
    </div>
